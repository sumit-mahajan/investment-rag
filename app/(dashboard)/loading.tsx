...
export default function DashboardLoading() {
  return (
    <div className="max-w-7xl mx-auto space-y-8">
      {/* Header skeleton */}
      <div>
        <div className="h-9 bg-slate-200 rounded animate-pulse w-40 max-w-full mb-2" />
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="flex items-center justify-between">
            <div className="space-y-2">
              ...
              <div className="h-4 bg-slate-100 rounded animate-pulse w-48 max-w-full" />
            </div>
          </div>
          ...
          <Card className="border-slate-200 bg-white shadow-sm">
            <CardContent className="p-4 sm:p-6">
              <div className="flex flex-col items-center justify-center w-full h-36 sm:h-48 border-2 border-dashed border-slate-200 rounded-xl">
                <div className="p-3 rounded-full bg-slate-100 animate-pulse mb-3">
                  <div className="w-6 h-6" />
                </div>
                <div className="h-4 bg-slate-200 rounded animate-pulse w-40 max-w-[80%] mb-2" />
                <div className="h-3 bg-slate-100 rounded animate-pulse w-32 max-w-[70%]" />
              </div>
            </CardContent>
          </Card>
